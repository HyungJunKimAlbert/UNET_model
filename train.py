...
class UNet(nn.Module):
    ...
    # Expanding Path
        ...
        # number of class
        self.fc = nn.Conv2d(in_channels=64, out_channels=2, kernel_size=1, stride=1, padding=1, bias=True)
    ...
    def forward(self, x):
        ...
        unpool3 = self.unpool2(dec4_1)
        cat3 = torch.cat((unpool3, enc3_2), dim=1)
        dec3_2 = self.dec3_2(cat3)
        dec3_1 = self.dec3_1(dec3_2)

        unpool2 = self.unpool1(dec3_1)
